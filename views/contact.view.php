        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/vanillaphp/index.php" aria-current="page" class=" text-gray-300 hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium">Home</a>
              ...
              <a href="/vanillaphp/contact.php" class=" bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
